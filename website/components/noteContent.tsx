...
export default function NoteContent({ content }: NoteContentProps) {
    return (
        <article className="markdown-body bg-neutral-900 p-6 rounded-lg max-w-none">
            <ReactMarkdown
                ...
                components={{
                    ...
                    p: ({ node, ...props }) => <p className="my-3 text-neutral-200 leading-relaxed" {...props} />,
                    ...
                    a: ({ node, ...props }) => <a className="text-yellow-400 hover:underline" {...props} />,
                    code: ({ node, ...props }) => <code className="bg-neutral-800 px-1.5 py-0.5 rounded text-sm font-mono" {...props} />,
                    pre: ({ node, ...props }) => <pre className="bg-neutral-800 p-4 rounded overflow-x-auto my-4" {...props} />,
                    blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-yellow-500 pl-4 italic text-neutral-300" {...props} />,
                }}
            >
                {content}
            </ReactMarkdown>
